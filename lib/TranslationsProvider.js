...
exports.TranslationsProvider = function (_a) {
    ...
    return (react_1.default.createElement(TranslationsContext_1.TranslationsContext.Provider, { value: { state: state, dispatch: dispatch } },
